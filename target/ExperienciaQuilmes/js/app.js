var quilmesApp = angular.module('quilmesApp', []);


/**
Controllers
*/
quilmesApp.controller('BotellaController', ['$scope', function($scope) {
  self = this;
 ...
 this.send = function send() {
    ...
    //adding the file to form data TODO refactor this, to make it compatible with older browsers. REST
